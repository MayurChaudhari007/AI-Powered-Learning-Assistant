...
const QuizResultView = ({ result, quiz, onBack, onRetest,docTitle }) => {
        ...
        <div className="relative z-10">
          <div className="flex justify-center mb-6 md:mb-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gray-50 border border-gray-100 rounded-full shadow-sm">
              <FaBookOpen className="text-gray-400 text-[10px] md:text-xs" />
              <span className="text-[9px] md:text-[10px] font-black text-gray-500 uppercase tracking-widest truncate max-w-50 md:max-w-xs">
                {displayTitle}
              </span>
            </div>
          </div>
